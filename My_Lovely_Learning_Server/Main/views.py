...
def favorit_cource(request):
    return render(request, 'Main_templates/user_learn_cource_favorit.html')

def archiv_cource(request):
    return render(request, 'Main_templates/user_learn_cource_archiv.html')

def class_cource(request):
    return render(request, 'Main_templates/user_learn_class.html')
